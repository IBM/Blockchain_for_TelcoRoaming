    ...
    beforeEach(() => {
        ...
        return adminConnection.createProfile('defaultProfile', { type : 'embedded' })
            ...
            .then(() => {
                ...
                const alice = factory.newResource('org.gsc.roaming', 'CSP','alice@email.com');
                alice.region = 'A';
                const bob = factory.newResource('org.gsc.roaming', 'CSP', 'bob@email.com');
                bob.region = 'B';
                return businessNetworkConnection.getParticipantRegistry('org.gsc.roaming.CSP')
            ...
            .then(() => {
                ...
                // Create the assets.
                const asset1 = factory.newResource('org.gsc.roaming', 'MSISDN', '1');
                asset1.servpro = factory.newRelationship('org.gsc.roaming', 'CSP', 'alice@email.com');
                asset1.custname = '10';
                asset1.emailid = 'aaa';
                const asset2 = factory.newResource('org.gsc.roaming', 'MSISDN', '2');
                asset2.servpro = factory.newRelationship('org.gsc.roaming', 'CSP', 'bob@email.com');
                asset2.custname = '20';
                asset2.emailid = 'bbb';
                return businessNetworkConnection.getAssetRegistry('org.gsc.roaming.MSISDN')
                    .then((assetRegistry) => {
            ...
            .then(() => {
                ...
                return businessNetworkConnection.issueIdentity('org.gsc.roaming.CSP#alice@email.com', 'alice1')
                    .then((identity) => {
                        aliceIdentity = identity;
                        return businessNetworkConnection.issueIdentity('org.gsc.roaming.CSP#bob@email.com', 'bob1');
                    })
                    .then((identity) => {
    ...
    it('Alice can read all of the assets', () => {
        ...
        return useIdentity(aliceIdentity)
            ...
            .then((assets) => {
                ...
                asset1.servpro.getFullyQualifiedIdentifier().should.equal('org.gsc.roaming.CSP#alice@email.com');
                asset1.custname.should.equal('10');
                const asset2 = assets[1];
                asset2.servpro.getFullyQualifiedIdentifier().should.equal('org.gsc.roaming.CSP#bob@email.com');
                asset2.custname.should.equal('20');
    ...
    it('Alice can add assets that she owns', () => {
        ...
        return useIdentity(aliceIdentity)
            .then(() => {
                ...
                // Create the asset.
                const asset3 = factory.newResource('org.gsc.roaming', 'MSISDN', '3');
                asset3.servpro = factory.newRelationship('org.gsc.roaming', 'CSP', 'alice@email.com');
                asset3.custname = '30';
                asset3.emailid='ccc';
            ...
            .then((asset3) => {
                ...
                // Validate the asset.
                asset3.servpro.getFullyQualifiedIdentifier().should.equal('org.gsc.roaming.CSP#alice@email.com');
                asset3.custname.should.equal('30');
    ...
    it('Alice cannot add assets that Bob owns', () => {
        ...
        return useIdentity(aliceIdentity)
            .then(() => {
                ...
                // Create the asset.
                const asset3 = factory.newResource('org.gsc.roaming', 'MSISDN', '3');
                asset3.servpro = factory.newRelationship('org.gsc.roaming', 'CSP', 'bob@email.com');
                asset3.custname = '30';
                asset3.emailid='ccc';
    ...
    it('Bob can add assets that he owns', () => {
        ...
        return useIdentity(bobIdentity)
            .then(() => {
                ...
                // Create the asset.
                const asset4 = factory.newResource('org.gsc.roaming', 'MSISDN', '4');
                asset4.servpro = factory.newRelationship('org.gsc.roaming', 'CSP', 'bob@email.com');
                asset4.custname = '40';
                asset4.emailid='ddd';
            ...
            .then((asset4) => {
                ...
                // Validate the asset.
                asset4.servpro.getFullyQualifiedIdentifier().should.equal('org.gsc.roaming.CSP#bob@email.com');
                asset4.custname.should.equal('40');
    ...
    it('Bob cannot add assets that Alice owns', () => {
        ...
        return useIdentity(bobIdentity)
            .then(() => {
                ...
                // Create the asset.
                const asset4 = factory.newResource('org.gsc.roaming', 'MSISDN', '4');
                asset4.servpro = factory.newRelationship('org.gsc.roaming', 'CSP', 'alice@email.com');
                asset4.custname = '40';
                asset4.emailid='ddd';
    ...
    it('Alice can update her assets', () => {
        ...
        return useIdentity(aliceIdentity)
            ...
            .then((asset1) => {
                ...
                // Validate the asset.
                asset1.servpro.getFullyQualifiedIdentifier().should.equal('org.gsc.roaming.CSP#alice@email.com');
                asset1.custname.should.equal('50');
    ...
    it('Bob can update his assets', () => {
        ...
        return useIdentity(bobIdentity)
            ...
            .then((asset2) => {
                ...
                // Validate the asset.
                asset2.servpro.getFullyQualifiedIdentifier().should.equal('org.gsc.roaming.CSP#bob@email.com');
                asset2.custname.should.equal('60');
    ...
    it('Alice can submit a transaction for her assets', () => {
        ...
        return useIdentity(aliceIdentity)
            .then(() => {
                ...
                const transaction = factory.newTransaction('org.gsc.roaming', 'Test');
                transaction.asset = factory.newRelationship('org.gsc.roaming', 'MSISDN', '1');
                transaction.custname = '50';
            ...
            .then((asset1) => {
                ...
                event.asset.getFullyQualifiedIdentifier().should.equal('org.gsc.roaming.MSISDN#1');
                event.donor.should.equal('10');
                event.recp.should.equal('50');
    ...
    it('Alice cannot submit a transaction for Bob\'s assets', () => {
        ...
        return useIdentity(aliceIdentity)
            .then(() => {
                ...
                // Submit the transaction.
                const transaction = factory.newTransaction('org.gsc.roaming', 'Test');
                transaction.asset = factory.newRelationship('org.gsc.roaming', 'MSISDN', '2');
                transaction.custname = '50';
                return businessNetworkConnection.submitTransaction(transaction);
    ...
    it('Bob can submit a transaction for his assets', () => {
        ...
        return useIdentity(bobIdentity)
            ...
            .then((asset2) => {
                ...
                event.eventId.should.be.a('string');
                event.timestamp.should.be.an.instanceOf(Date);
                event.asset.getFullyQualifiedIdentifier().should.equal('org.gsc.roaming.MSISDN#2');
                event.donor.should.equal('20');
                event.recp.should.equal('60');
